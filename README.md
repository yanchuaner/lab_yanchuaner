...
Lab 是“2026 燕中生态暑期预览”的科创共建子站。暑期结束时不追求堆满教程，而是交付一套可以真正带新成员完成第一次贡献的内容系统：清晰分类、中文主内容、渐进英文翻译、真实仓库、可验证命令和统一参与入口。

预览版至少完成开源协作、App/小程序、Agent 三类学习入口，持续展示主站、小程序、燕中 API、燕中 AI 与 YCZX Code 等真实项目。正式版计划在大二上学期根据阅读完成率、教程反馈和真实贡献记录持续打磨，而不是简单更换版本号。
